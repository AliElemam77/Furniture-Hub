        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-4 sm:gap-6">
          ...
          <div className="text-center sm:text-left">
            ...
            <dl className="mt-1 text-sm text-gray-600">
              <div>
                ...
                <dd className="inline font-semibold text-gray-800 ml-1">
                  {item.price} $
                </dd>
              </div>
            </dl>
          ...
          <div className="flex items-center justify-center sm:justify-end gap-3">
            <input
              ...
              defaultValue="1"
              id="Line1Qty"
              className="h-9 w-16 rounded border border-gray-300 bg-white text-center text-sm text-gray-700 shadow-sm focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500"
            />
